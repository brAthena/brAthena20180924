...
******************************************************************************
* src/map/atcommand.c                                                        *
* Respons�vel pelo funcionamento de @comandos dentro do emulador             *
******************************************************************************
...
ACMD(item)
{
	...
	if( !strcmpi(command+1,"costumeitem") ) {
		if( !battle_config.reserved_costume_id ) {
			clif->message(fd, "A convers�o visual est� desabilitada. Defina um valor para a vari�vel reserved_costume_id no arquivo battle/items.conf");
			return -1;
		}
		...
		{
			clif->message(fd, "Voc� n�o pode converter este item. A convers�o visual s� pode ser feita em chap�us.");
			return -1;
		}
		costume = 1;
	}
