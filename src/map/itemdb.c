...
******************************************************************************
* src/map/itemdb.c                                                           *
* Respons�vel pela leitura e verifica��es dos itens do banco de dados        *
******************************************************************************
...
const char* itemdb_typename(int type)
{
	switch(type)
	{
		case IT_HEALING:        return "Po��o/Comida";
		case IT_USABLE:         return "Us�vel";
		...
		case IT_PETARMOR:       return "Acess�rio de Bicinho";
		case IT_AMMO:           return "Flecha/Muni��o";
		case IT_DELAYCONSUME:   return "[Delay] Item Consum�vel";
		case IT_CASH:           return "Cash Us�vel";
	}
	return "Unknown Type";
}
...
#ifdef ENABLE_CASE_CHECK
	script->parser_current_file = "Database de Item (Provavelmente um Nome Aegis inv�lido ou em Conflito)";
#endif // ENABLE_CASE_CHECK
