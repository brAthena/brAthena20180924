...
******************************************************************************
* src/map/packets.h                                                          *
* Banco de packets para comunica��o com o client                             *
******************************************************************************
...
//Inclu�do diretamente pelo clif.h em packet_loaddb()
 ...
 * Ou
 * - packet(id_do_pacote,comprimento,fun��o,deslocamento ( Especifica o deslocamento de um campo de pacote em bytes desde o in�cio do pacote ),...)
...
//2011-07-18aRagexe (Thanks to Yommy!)
	...
	packet(0x0844,2,clif->pCashShopOpen,2);/* diz ao servidor que a janela de cashshop est� sendo aberta */
	packet(0x084a,2,clif->pCashShopClose,2);/* diz ao servidor que a janela de cashshop est� sendo fechada */
...
// ========== 2012-07-02aRagexeRE  =============
// - 2012-07-02  N�o � Est�vel.
// - Os pacotes s�o mantidos aqui para refer�ncia, N�o Use-os.
...
//2014-06-12aRagexe - 2014-06-13aRagexe
...
//2015-09-16Ragexe
	...
	packet(0x0869,7,clif->pActionRequest,2,6);
 	...
 	//packet(// 0x094F,8, clif->pCZ_JOIN_BATTLE_FIELD);
 	...
 	//packet(// 0x0938,4, clif->pCZ_GANGSI_RANK);
 ...
 //New Packet
 	packet(0x097F,-1);		// ZC_SELECTCART
 	packet(0x0980,7,clif->pSelectCart,2,6);	// CZ_SELECTCART
#endif
...
#if PACKETVER >= 20150916
	packetKeys(0x17F83A19,0x116944F4,0x1CC541E9); /* Napster */
#endif
