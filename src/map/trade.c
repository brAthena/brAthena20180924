...
******************************************************************************
* src/map/trade.c                                                            *
* Funções referentes à negociação entre jogadores                            *
******************************************************************************
	...
	for( trade_i = 0; trade_i < 10; trade_i++ )
	{
		...
		if (sd->deal.item[trade_i].amount)
		{
			...
			if (flag == 0){
				...
				pc->delitem(sd, n, sd->deal.item[trade_i].amount, 1, DELITEM_SOLD);
		...
		if (tsd->deal.item[trade_i].amount)
		{
			...
			if (flag == 0){
				...
				pc->delitem(tsd, n, tsd->deal.item[trade_i].amount, 1, DELITEM_SOLD);
			}
			else
